...
// exports.ResourceManagerXHR = class ResourceManagerXHR {
      ...
      .then(arraybuffer => {
        ...
        while (memorySize > 0) {
          ...
          if (
            ...
            if (
              !Decoder4D._keepChunksInCache ||
              Decoder4D.chunks4D.length < parent._sequenceInfo.NbFrames * 2
            ) {
